...
#define DEFAULT_BIT_DELAY  100
 ...
 void TM1637init(uint8_t brightness);
...
void TM1637DispNum		(uint16_t Num);
void TM1637Display_off	(void); 
void TM1637Display_showNumberBaseEx(int8_t base, uint16_t num, uint8_t dots, bool leading_zero, uint8_t length, uint8_t pos);
